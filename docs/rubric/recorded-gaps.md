...
- **evidence**: endpoint-fatal exit 2 in `doBehaveRun` (`return 2` (`src/cli/index.ts:479-489`)) and `doA2aBehavioralRun` (`return 2` (`src/cli/index.ts:1157-1162`)) vs. no such special case, exit 1 on any failure in `doSkillsRun` (`return ok ? 0 : 1` (`src/cli/index.ts:1580-1584`)) and `doSopRun` (`report.passed ? 0 : 1` (`src/cli/index.ts:1701-1703`)); garrison-hq/muster#78, reproduced live against `skills run` (`skills: FAIL — 1/3 cases passed, 2 failed`, `$?` = 1).
